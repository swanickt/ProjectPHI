...
def test_builtin_component_extensions_preserve_observed_tool_fragments_in_phrase_context():
    examples = [
        ...
        ("The tumor was Elston SBR grade 2.", "Elston"),
        ...
        ("The rhythm showed torsade de pointes.", "de"),
        ("The rhythm showed torsade de pointes.", "pointes"),
        ("Findings showed en coup de sabre.", "de"),
        ("Findings showed en coup de sabre.", "sabre"),
        ("The Gugging Swallowing Screen was administered.", "Gugging"),
...
def test_builtin_component_extensions_do_not_preserve_risky_tokens_globally():
    examples = [
        ...
        ("Pointes attended the visit.", "Pointes"),
        ("Sabre attended the visit.", "Sabre"),
        ("Gugging attended the visit.", "Gugging"),
