...
_CLINICAL_CODE_CONTEXT_RULES = {
    ...
    "PASH": ("breast_pathology_abbreviation", ("pseudoangiomatous stromal", "stromal hyperplasia", "breast", "fibrocystic")),
    "DIEP": ("breast_reconstruction_abbreviation", ("diep flap", "deep inferior epigastric", "breast reconstruction", "flap reconstruction", "abdominal flap")),
    "GUSS": ("swallowing_screen_abbreviation", ("gugging swallowing", "swallowing screen", "dysphagia", "bedside swallow")),
